    ...
    public class CRectangle
    {
        ...
        public Vector2[] Points
        {
            get
            {
                ...
                if (Rotation != 0)
                {
                    points[0] = RotatePointAroundZero(points[0], Rotation);
                    points[1] = RotatePointAroundZero(points[1], Rotation);
                    points[2] = RotatePointAroundZero(points[2], Rotation);
                    points[3] = RotatePointAroundZero(points[3], Rotation);
                }
        ...
        public bool Contains(float x, float y)
        {
            ...
            else
            {
                ...
                Vector2 rot = RotatePointAroundZero(localX, localY, -Rotation);
        ...
        private Vector2 RotatePointAroundZero(Vector2 point, float rotation)
        {
            return RotatePointAroundZero(point.X, point.Y, rotation);
        }

        private Vector2 RotatePointAroundZero(float x, float y, float rotation)
        {
