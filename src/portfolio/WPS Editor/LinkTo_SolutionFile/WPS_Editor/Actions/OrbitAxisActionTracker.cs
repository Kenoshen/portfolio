...
{
    class OrbitAxisActionTracker : WPSActionTracker
    {
        ...
        public OrbitAxisActionTracker(string name, RefreshingListBox parent, bool isPerm)
        {
            perm = isPerm;
        ...
        {
            string xml = "";
            xml += "<action,type=OrbitAxisAction>\n" +
