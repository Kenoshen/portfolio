...
namespace WPS
{
    public class MoveAction : WPSAction
    {
        ...
        public MoveAction(GraphicsDevice GraphicsDevice, ContentManager Content, float timeStep = 1)
        {
            this.TimeStep = timeStep;
            this.GraphicsDevice = GraphicsDevice;

            effect = Content.Load<Effect>(Global_Variables_WPS.ContentActionEffects + "Move");
        }
